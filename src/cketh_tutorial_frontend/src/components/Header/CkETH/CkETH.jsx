...
function CkETH({ walletConnected, account }) {
  ...
  return (
    <div className='container'>
      ...
      <div className='sections-container'>
        <div className='section-row'>
          <div className='section'>
            <h2>Fetch ckETH Canister ID</h2>
            <button onClick={depositAddress} className='button'>Get ckETH Canister ID</button>
      ...
      <div className='documentation'>
        <h2>How to Mint ckETH to Your Principal ID</h2>
        <ol>
