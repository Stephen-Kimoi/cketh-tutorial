...
function Header() {
    ...
    return (<div className='container'>
      ...
      <div className='wallet-info'>
        {isConnected ? (<p>Connected Wallet: <strong>{address}</strong></p>) : (<p>No wallet connected</p>)}
      </div>
      ...
      <div className='sections-container'>
        <div className='section-row'>
          ...
          <div className='section'>
            ...
            <div className='form'>
              ...
              <input type="text" value={canisterDepositAddress} onChange={changeAddressHandler} placeholder="Byte32 Deposit Address" disabled={isWriteLoading || isTxLoading} className='input'/>
              <input type="number" value={amount} onChange={changeAmountHandler} placeholder="Amount" disabled={isWriteLoading || isTxLoading} className='input'/>
        ...
        <div className='section-row'>
          <div className='section'>
            ...
            <div className='form'>
              <input type="text" value={principalId} onChange={changePrincipalIdHandler} placeholder="Principal ID" className='input'/>
              <button onClick={checkCkEthBalance} disabled={loading} className='button'>
                {loading ? 'Checking...' : 'Check Balance'}
              </button>
            </div>
            {ckEthBalance !== null && (<div className='balance-display'>
          ...
          <div className='section'>
            ...
            {generatedByte32Address && (<div className='address-display'>
          ...
          <div className='section'>
            ...
            <div className='form'>
              <input type="text" value={transactionHash} onChange={changeTransactionHashHandler} placeholder="Transaction Hash" disabled={isVerifying} className='input'/>
        ...
        {verificationResult && (<div className='verification-result'>
            <h2>Verification Result:</h2>
            <pre>{JSON.stringify(verificationResult, null, 2)}</pre>
          </div>)}

        {verificationError && (<div className='error-message'>
