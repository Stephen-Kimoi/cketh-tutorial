...
function CkUSDC({ walletConnected, account }) {
  ...
  return (
    <div className='container relative'>
          ...
          <div className='section'>
            ...
            {ckEthBalance !== null && (
              <div className='balance-display'>
                <p>ckUSDC Balance: {ckEthBalance}</p>
              </div>
            )}
          </div>
      ...
      <div className='documentation'>
        <h2>How to Mint ckUSDC to Your Principal ID</h2>
        <ol>
          ...
          <li><strong>Step 4:</strong> Put the generated Byte32 address in the <b>Deposit ckUSDC section</b> and enter amount of ckUSDC you'd like to deposit</li>
